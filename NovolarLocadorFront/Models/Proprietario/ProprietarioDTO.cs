...
namespace NovolarLocadorFront.Models.Proprietario
{
    ...
    {
        public List<ProprietariosBeneficiarios> proprietarios_beneficiarios { get; set; } = new List<ProprietariosBeneficiarios>();
        public int Id { get; set; }//public string id_pessoa_pes { get; set; }
        public string Nome { get; set; }//public string st_nome_pes { get; set; }
        public string CpfCnpj { get; set; }//public string st_cnpj_pes { get; set; }
        public string NomeFantasia { get; set; }//public string st_fantasia_pes { get; set; }
        public string Rg { get; set; }//public string st_rg_pes { get; set; }
        //public string st_orgao_pes { get; set; }
        public string Ie { get; set; }//public string st_ie_pes { get; set; }
        //public string st_inscmunicipal_pes { get; set; }
        public string Endereco { get; set; }//public string st_endereco_pes { get; set; }
        public string Complemento { get; set; }//public string st_complemento_pes { get; set; }
        public string Numero { get; set; }//public string st_numero_pes { get; set; }
        public string Cidade { get; set; }//public string st_cidade_pes { get; set; }
        public string Estado { get; set; }//public string st_estado_pes { get; set; }
        public string Cep { get; set; }//public string st_cep_pes { get; set; }
        public string Bairro { get; set; }//public string st_bairro_pes { get; set; }
        public string Telefone { get; set; }//public string st_telefone_pes { get; set; }
        public string Celular { get; set; }//public string st_celular_pes { get; set; }
        public string Email { get; set; }//public string st_email_pes { get; set; }
        public string Observacao { get; set; }//public string st_observacao_pes { get; set; }
        public string Nacionalidade { get; set; }//public string st_nacionalidade_pes { get; set; }
        public string Sexo { get; set; }//public string st_sexo_pes { get; set; }
        public string DataNascimento { get; set; }//public string dt_nascimento_pes { get; set; }
        public string EstadoCivil { get; set; }//public string st_estadocivil_pes { get; set; }
        public string Profissão { get; set; }//public string st_profissao_pes { get; set; }
